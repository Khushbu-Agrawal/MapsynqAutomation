...
{
    // Class provides all interactions with MobileApp page
    class MobileAppPage : BasePage
    {
        // Constants
        private const String PAGE_TITLE = "mapSYNQ Mobile";

        // Constructor
        public MobileAppPage(IWebDriver p_Driver)
        {
            driver = p_Driver;
